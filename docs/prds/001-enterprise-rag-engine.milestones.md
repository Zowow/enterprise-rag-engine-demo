...
### [ ] Milestone 3: Document Upload API & Azurite Queue Dispatch
...
### [ ] Milestone 4: SignalR Ingestion Hub & Progress Broadcasting
...
### [ ] Milestone 5: Background Ingestion Worker & Qdrant Vector Upsert
